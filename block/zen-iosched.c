...
static void
zen_dispatch(struct zen_data *, struct request *);

static void
zen_merged_requests(struct request_queue *q, struct request *rq, struct request *next)
{
    /*
...
static void 
zen_dispatch(struct zen_data *zdata, struct request *rq)
{
