...
static 
void tripndroid_merged_requests(struct request_queue *q, struct request *rq,
                                                        struct request *next)
{
	/*
...
static
void tripndroid_add_request(struct request_queue *q, struct request *rq)
{
...
static
struct request *tripndroid_expired_request(struct tripndroid_data *td, int sync, int data_dir)
{
...
static
struct request *tripndroid_choose_expired_request(struct tripndroid_data *td)
{
	struct request *rq;
...
static 
struct request *tripndroid_choose_request(struct tripndroid_data *td, int data_dir)
{
...
static
inline void tripndroid_dispatch_request(struct tripndroid_data *td, struct request *rq)
{
...
static 
int tripndroid_dispatch_requests(struct request_queue *q, int force)
{
	struct tripndroid_data *td = q->elevator->elevator_data;
...
static 
struct request *tripndroid_former_request(struct request_queue *q, struct request *rq)
{
	struct tripndroid_data *td = q->elevator->elevator_data;
	const int sync = rq_is_sync(rq);
	const int data_dir = rq_data_dir(rq);
...
static 
struct request *tripndroid_latter_request(struct request_queue *q, struct request *rq)
{
	struct tripndroid_data *td = q->elevator->elevator_data;
	const int sync = rq_is_sync(rq);
	const int data_dir = rq_data_dir(rq);
...
static 
void * tripndroid_init_queue(struct request_queue *q)
{
...
static 
void tripndroid_exit_queue(struct elevator_queue *e)
{
...
static 
struct elevator_type iosched_tripndroid = {
	.ops = {
...
static 
int __init tripndroid_init(void)
{
...
static 
void __exit tripndroid_exit(void)
{
